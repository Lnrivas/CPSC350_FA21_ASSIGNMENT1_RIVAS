 ...
 * This is the implementation .cpp file for the FileProcessor class. Used for file processing, reading from one file and then writing the tutnese translation to output file. 
*/
